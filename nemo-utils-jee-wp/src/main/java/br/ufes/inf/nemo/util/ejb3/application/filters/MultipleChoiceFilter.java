...
public class MultipleChoiceFilter<T> extends AbstractFilter<T> {
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.AbstractFilter#getOptions() */
	@Override
	public List<T> getOptions() {
		return options;
	}

	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.AbstractFilter#getOptionLabel(java.lang.String) */
	@Override
	public String getOptionLabel(String key) {
		return optionsLabels.get(key);
	}

	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.Filter#getType() */
	@Override
	public FilterType getType() {
		return FilterType.MULTIPLE_CHOICE;
	}

	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.AbstractFilter#getOptionsLabels() */
	@Override
	public Map<String, String> getOptionsLabels() {
		return optionsLabels;
	}

	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.AbstractFilter#getReversedOptionsLabels() */
	@Override
