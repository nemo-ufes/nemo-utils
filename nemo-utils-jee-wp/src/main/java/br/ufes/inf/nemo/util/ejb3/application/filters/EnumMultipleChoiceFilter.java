...
public class EnumMultipleChoiceFilter<T, E extends Enum<E>> extends MultipleChoiceFilter<T> {
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.AbstractFilter#getEnum(java.lang.String) */
	public Enum<E> getEnum(String value) {
		return Enum.valueOf(enumClass, value);
	}

	/** @see br.ufes.inf.nemo.util.ejb3.application.filters.MultipleChoiceFilter#getType() */
	@Override
