...
public abstract class ListingServiceBean<T extends PersistentObject> implements ListingService<T> {
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.ListingService#authorize() */
	public void authorize() {
		logger.log(Level.FINE, "Authorization not overridden by subclass. No need for authorization.");
	}

	/** @see br.ufes.inf.nemo.util.ejb3.application.ListingService#count() */
	@Override
	public long count() {
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.ListingService#list(int[]) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.application.ListingService#fetchLazy(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
