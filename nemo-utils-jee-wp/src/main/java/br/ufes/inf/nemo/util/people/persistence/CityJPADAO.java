...
import br.ufes.inf.nemo.util.people.domain.City;
import br.ufes.inf.nemo.util.people.domain.City_;
import br.ufes.inf.nemo.util.people.domain.State;
import br.ufes.inf.nemo.util.people.domain.State_;
 ...
 * @see br.ufes.inf.nemo.util.people.domain.City
 * @see br.ufes.inf.nemo.util.people.persistence.CityDAO
 */
@Stateless
public class CityJPADAO extends BaseJPADAO<City> implements CityDAO {
	...
	/** @see br.ufes.inf.nemo.util.people.persistence.CityDAO#findByName(java.lang.String) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.people.persistence.CityDAO#retrieveByNameAndStateAcronym(java.lang.String, java.lang.String) */
	@Override
