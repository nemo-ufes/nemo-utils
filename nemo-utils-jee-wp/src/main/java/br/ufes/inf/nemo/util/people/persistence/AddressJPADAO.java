...
import br.ufes.inf.nemo.util.people.domain.Address;
 ...
 * @see br.ufes.inf.nemo.util.people.domain.Address
 * @see br.ufes.inf.nemo.util.people.persistence.AddressDAO
 */
@Stateless
