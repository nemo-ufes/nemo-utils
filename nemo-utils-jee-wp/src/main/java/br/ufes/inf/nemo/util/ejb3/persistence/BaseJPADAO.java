...
public abstract class BaseJPADAO<T extends PersistentObject> implements BaseDAO<T> {
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#retrieveCount() */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#retrieveAll() */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#retrieveSome(int[]) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#retrieveById(java.lang.Long) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#save(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#delete(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#merge(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
	...
	/** @see br.ufes.inf.nemo.util.ejb3.persistence.BaseDAO#refresh(br.ufes.inf.nemo.util.ejb3.persistence.PersistentObject) */
	@Override
