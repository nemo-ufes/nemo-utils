...
import br.ufes.inf.nemo.util.people.domain.Telephone;
 ...
 * @see br.ufes.inf.nemo.util.people.domain.Telephone
 * @see br.ufes.inf.nemo.util.people.persistence.TelephoneDAO
 */
@Stateless
